...
from weather.data_collection.netatmo_domain import NetatmoStation, NetatmoModule
...
def test_domain_station():
    station = NetatmoStation(**MOCK_STATION_CONFIG['station:mock:id:1'])
